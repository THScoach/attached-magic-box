...
CREATE INDEX idx_drill_recommendations_user_id ON drill_recommendations(user_id);
CREATE INDEX idx_drill_recommendations_analysis_id ON drill_recommendations(analysis_id);
CREATE INDEX idx_drill_recommendations_created_at ON drill_recommendations(created_at DESC);
