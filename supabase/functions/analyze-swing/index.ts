...
**⚠️ CRITICAL: MANDATORY 3-STEP CONTACT-FIRST DETECTION ⚠️**

**YOU MUST FOLLOW THIS EXACT SEQUENCE - NO EXCEPTIONS:**

═══════════════════════════════════════════════════════════════
**STEP 1: DETECT CONTACT FRAME (DO THIS FIRST - MANDATORY)**
═══════════════════════════════════════════════════════════════

**SCAN WINDOW:** Look at frames representing 5-25% through the video ONLY.
- For 300fps video, this is approximately frames 100-500 of a 1940-frame video
- For 60fps video, this is approximately frames 20-100 of a 400-frame video

**CONTACT DETECTION CHECKLIST (You need 3+ of these to confirm contact):**
✅ 1. **Ball disappears/blurs** suddenly (most reliable cue)
✅ 2. **Bat is fully extended** through the zone (not still loading back)
✅ 3. **Hips are FULLY rotated** forward (90-130° of rotation visible)
✅ 4. **Front leg is STRAIGHT/BRACED** (knee locked, not bent)
✅ 5. **Hands are extended** toward pitcher (not back near body)
✅ 6. **Shoulders are FULLY rotated** (chest facing pitcher, not sideways)

**WHAT CONTACT LOOKS LIKE (Frame-by-Frame Reference):**
- Frame BEFORE contact: Ball visible, bat approaching, body rotating
- Frame AT contact: Ball blurs/disappears, bat in hitting zone, body at maximum rotation
- Frame AFTER contact: Ball gone, bat begins deceleration, body begins follow-through

**MARK THIS FRAME AS:** Contact Frame equals 0ms (your absolute reference point)

**CRITICAL VALIDATION:**
- Contact frame should be in the FIRST 5-25% of video (NOT 80-90%!)
- If you're detecting contact late (>30% through video), you're WRONG - rescan earlier frames
- Example: In a 1940-frame video, contact at frame 193 (10%) = CORRECT
- Example: In a 1940-frame video, contact at frame 1600 (82%) = WRONG (that's follow-through)

═══════════════════════════════════════════════════════════════
**STEP 2: FIND MAX LOAD POSITION (Work BACKWARD from Contact)**
═══════════════════════════════════════════════════════════════

**SCAN WINDOW:** Scan 200-400ms BEFORE the Contact frame (work backwards)
- Calculate: Contact frame time minus 0.200s to Contact frame time minus 0.400s
- Example: If Contact equals 0.643s, scan frames from 0.243s to 0.443s

**MAX LOAD DETECTION CHECKLIST (Peak of the load phase):**
✅ 1. **Hands are at HIGHEST/FURTHEST BACK position** (maximum separation from pitcher)
✅ 2. **Hip-shoulder separation is MAXIMUM** (X-Factor at peak, ~25-40°)
✅ 3. **Front leg is at PEAK OF LIFT** or just landing (leg kick maximum)
✅ 4. **Weight is FULLY on back leg** (back knee bent, loading back)
✅ 5. **Back hip is ROTATED AWAY** from pitcher (maximum coil)

**WHAT MAX LOAD LOOKS LIKE:**
- This is the "launch position" - highest potential energy
- Body coiled like a spring, ready to explode forward
- Hands back and up, front leg lifted or just landing

**MARK THIS FRAME TIME AS:** LoadStartTiming equals X ms before contact
- Calculate: (Contact frame time - Max Load frame time) multiplied by 1000 equals milliseconds
- Example: Contact 0.643s - Load 0.397s equals 0.246s equals 246ms before contact
- Report as POSITIVE value: loadStartTiming: 246

**TYPICAL RANGES:**
- Elite power hitters: 200-300ms before contact (Freeman: 246ms)
- Contact hitters: 300-400ms before contact

═══════════════════════════════════════════════════════════════
**STEP 3: FIND FIRE START (Work BACKWARD from Contact)**
═══════════════════════════════════════════════════════════════

**SCAN WINDOW:** Scan 150-250ms BEFORE the Contact frame
- This should be IMMEDIATELY AFTER Max Load position (1-10 frames later)
- Calculate: Contact frame time minus 0.150s to Contact frame time minus 0.250s

**FIRE START DETECTION CHECKLIST:**
✅ 1. **Front foot LANDS/PLANTS** firmly on ground (most reliable cue)
✅ 2. **Hips begin FORWARD rotation** (away from back, toward pitcher)
✅ 3. **Weight begins AGGRESSIVE forward transfer** (COM accelerates forward)
✅ 4. **Hands STILL BACK** maintaining separation (X-Factor maintained)
✅ 5. **Back leg begins to DRIVE/EXTEND** (pushing off rubber)

**WHAT FIRE START LOOKS LIKE:**
- Front foot plants → explosion begins
- Hips fire first, hands stay back (separation maintained)
- Weight transfers aggressively forward

**MARK THIS FRAME TIME AS:** FireStartTiming equals X ms before contact
- Calculate: (Contact frame time - Fire Start frame time) multiplied by 1000 equals milliseconds
- Example: Contact 0.643s - Fire 0.400s equals 0.243s equals 243ms before contact
- Report as POSITIVE value: fireStartTiming: 243

**TYPICAL RANGES:**
- Elite hitters: 150-250ms before contact (Freeman: 243ms)
- Should be very close to Max Load (within 0-50ms after)

═══════════════════════════════════════════════════════════════
**MANDATORY VALIDATION - CHECK YOUR WORK:**
═══════════════════════════════════════════════════════════════

**Frame Sequence Check (MUST be in this order):**
1. Contact frame < 30% through video ✓
2. Fire Start frame < Contact frame (earlier in video) ✓
3. Max Load frame < Fire Start frame (even earlier) ✓

**Timing Validation (ALL must be true):**
✓ LoadStartTiming: 200-400ms (typical elite range)
✓ FireStartTiming: 150-250ms (typical elite range)
✓ LoadStartTiming > FireStartTiming (load is earlier than fire)
✓ Load Duration: 50-200ms (LoadStart - FireStart)
✓ Fire Duration: 150-250ms (FireStart - 0)

**If ANY validation fails, RE-SCAN starting from STEP 1 (Contact detection)**

**EXAMPLE - Freddie Freeman (YOUR REFERENCE):**

Total video: 6.465s (1940 frames at 300fps)
Contact: Frame 193 = 0.643s = 10% through video
Max Load: Frame 119 = 0.397s results in 246ms BEFORE contact
Fire Start: Frame 120 = 0.400s results in 243ms BEFORE contact  
Load Duration: 246 - 243 = 3ms (very tight load)
Fire Duration: 243ms

**THIS IS YOUR CALIBRATION TARGET - Match these patterns!**
