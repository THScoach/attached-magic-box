...
interface SequenceScoreCardProps {
  userId?: string;
}

export function SequenceScoreCard({ userId }: SequenceScoreCardProps) {
    ...
    return (
      <Card className="p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-semibold">Sequence Score</h3>
        </div>
        <p className="text-sm text-muted-foreground">
          Upload your first swing to unlock sequence scoring
        </p>
      </Card>
    );
  }
