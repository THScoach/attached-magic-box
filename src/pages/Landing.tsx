      ...
      <section className="py-24 bg-zinc-950">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl mb-16 text-center">
            ...
            <p className="text-xl text-gray-300">
              Choose the path that fits your goals and commitment level
            </p>
          </div>

          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 max-w-7xl mx-auto">
            <Card className="border-white/10 bg-zinc-900 hover:border-primary/50 transition-all">
              <CardHeader>
                <div className="mb-2">
                  <span className="text-3xl font-black text-green-500">FREE</span>
                </div>
                <CardTitle className="text-lg font-black uppercase">HITS Tempo Score</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-primary/30 bg-zinc-900 hover:border-primary/50 transition-all">
              <CardHeader>
                <div className="mb-2">
                  <span className="text-3xl font-black text-primary">$9.97</span>
                </div>
                <CardTitle className="text-lg font-black uppercase">7-Day Challenge</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-400 mb-6">
                  Prove the system works with daily coaching
                </p>
                <Button asChild className="w-full bg-primary text-primary-foreground hover:bg-primary/90 font-bold">
            ...
            <Card className="border-white/10 bg-zinc-900 hover:border-primary/50 transition-all">
              <CardHeader>
                <div className="mb-2">
                  <span className="text-2xl font-black text-white">$29.97<span className="text-sm text-gray-400">/mo</span></span>
                </div>
                <CardTitle className="text-lg font-black uppercase">HITS Membership</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-400 mb-6">
                  Full platform access with unlimited analysis
                </p>
                <Button asChild className="w-full bg-primary text-primary-foreground hover:bg-primary/90 font-bold">
                  <Link to="/programs">Learn More</Link>
                </Button>
            ...
            <Card className="border-white/10 bg-zinc-900 hover:border-primary/50 transition-all">
              <CardHeader>
                <div className="mb-2">
                  <span className="text-xl font-black text-primary">Elite</span>
                </div>
                <CardTitle className="text-lg font-black uppercase">90-Day Transform</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-400 mb-6">
                  Done-with-you coaching with performance guarantee
                </p>
                <Button asChild className="w-full bg-primary text-primary-foreground hover:bg-primary/90 font-bold">
                  <Link to="/programs">Learn More</Link>
                </Button>
