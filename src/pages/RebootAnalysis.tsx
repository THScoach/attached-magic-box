    ...
    try {
      ...
      const { data: savedReport, error: saveError } = await supabase
        ...
        .insert({
          ...
          player_id: selectedPlayerId, // Associate with selected player
          pdf_url: publicUrl,
          label: `Report ${reports.length + 1}`,
          report_date: reportDate.toISOString().split('T')[0],
          // Timing data
          negative_move_time: timingData.negativeMoveTime ?? 0,
          max_pelvis_turn_time: timingData.maxPelvisTurnTime ?? 0,
          max_shoulder_turn_time: timingData.maxShoulderTurnTime ?? 0,
          max_x_factor_time: timingData.maxXFactorTime ?? 0,
